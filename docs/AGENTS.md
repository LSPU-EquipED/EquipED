...
- Use `docs/PRD.md` as supporting reference material.
...
- Do not loosen privacy/compliance language beyond what the PRD supports.

## Before Editing Docs

- Cross-check `openspec/specs/`, `PRD.md`, and the root `../AGENTS.md`.
