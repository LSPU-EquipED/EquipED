...
| ID | Requirement | Deliverable | Priority |
|---|---|---|---|
| FR-06 | The system shall evaluate each submitted SLM against the SME rubric criteria for Organization & Presentation and Assessment domains, and provide a separate non-scoring advisory check that substantial SLM content falls within the selected syllabus outcomes | D-01, D-02 | High |
