          ...
          {otherDomains.length === 0 ? (
            ...
            <div>
              ...
              <select
                ...
                disabled={isPending}
                className="mt-1.5 w-full h-9 rounded-sm border border-input bg-surface px-2.5 text-xs font-semibold text-text focus:outline-none focus:ring-2 focus:ring-ring"
              >
                {otherDomains.map((d) => (
