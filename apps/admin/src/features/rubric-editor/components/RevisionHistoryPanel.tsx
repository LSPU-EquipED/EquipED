    ...
    <div className="overflow-hidden rounded-md border border-border bg-surface">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border p-4 bg-surface-subtle">
        <div>
          ...
          <p className="text-xs text-text-muted font-medium">Revisions for {agentLabel}</p>
        </div>
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    {isActive && (
                      <span className="inline-flex items-center gap-1 rounded-sm bg-success-soft px-1.5 py-0.5 text-xs font-semibold text-success border border-success/20">
                ...
                <div className="mt-2 text-xs text-text-muted grid gap-0.5">
