...
import { Bell, ChevronDown, GraduationCap, LogOut, Search, Settings, UserCircle } from 'lucide-react';
        ...
        <div className="flex items-center gap-2">
          ...
          <div ref={accountMenuRef} className="relative">
            ...
            >
              ...
              <span className="hidden max-w-40 truncate text-sm sm:inline">{user?.displayName ?? 'EquipEd User'}</span>
