  ...
  return (
    <section style={{ display: 'grid', gap: '1rem' }}>
      <div>
        ...
        <h1 style={{ margin: '0.35rem 0 0', fontSize: '1.55rem' }}>Monitoring matrix scaffold</h1>
      </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ textAlign: 'left', color: '#8ba4d6' }}>
              <th style={{ paddingBottom: '0.75rem' }}>SLM</th>
              <th style={{ paddingBottom: '0.75rem' }}>Program</th>
              <th style={{ paddingBottom: '0.75rem' }}>Status</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td style={{ padding: '0.7rem 0', color: '#e5eefc' }}>No matrix rows yet</td>
