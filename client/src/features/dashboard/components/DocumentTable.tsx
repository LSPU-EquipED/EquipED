    ...
    <div className="overflow-x-auto">
      <table className="w-full text-left border-collapse border-spacing-0">
        <thead className="border-b border-slate-200 bg-slate-50/60">
          <tr>
            <th className="py-2.5 px-6 md:px-8 text-xs font-semibold uppercase tracking-wider text-slate-500 w-32">Status</th>
            <th className="py-2.5 px-4 text-xs font-semibold uppercase tracking-wider text-slate-500 w-[35%] min-w-[18rem]">Name</th>
            <th className="py-2.5 px-4 text-xs font-semibold uppercase tracking-wider text-slate-500 w-[25%] min-w-[14rem]">Course</th>
            <th className="py-2.5 px-4 text-xs font-semibold uppercase tracking-wider text-slate-500 w-28">Program</th>
            <th className="py-2.5 px-4 text-xs font-semibold uppercase tracking-wider text-slate-500 w-28">Type</th>
            <th className="py-2.5 px-4 text-xs font-semibold uppercase tracking-wider text-slate-500 w-36">Uploaded</th>
            ...
            return (
              ...
              >
                ...
                <td className="py-3.5 px-6 md:px-8 text-right w-12">
                  {isReady ? (
                    <ChevronRight
                      className="ml-auto size-4 text-slate-300 group-hover:text-slate-600 transition-colors"
                      aria-hidden="true"
                    />
                  ) : null}
                </td>
        ...
        <tbody className="divide-y divide-slate-100">
          {Array.from({ length: 5 }).map((_, idx) => (
            <tr key={idx} className="animate-pulse">
              <td className="py-4 px-6 w-32"><div className="h-5 w-16 bg-slate-200 rounded-sm" /></td>
              <td className="py-4 px-4 w-[35%] min-w-[18rem]"><div className="h-4 w-48 bg-slate-200 rounded-sm" /></td>
              <td className="py-4 px-4 w-[25%] min-w-[14rem]"><div className="h-4 w-36 bg-slate-200 rounded-sm" /></td>
              <td className="py-4 px-4 w-28"><div className="h-4 w-12 bg-slate-200 rounded-sm" /></td>
              <td className="py-4 px-4 w-28"><div className="h-4 w-12 bg-slate-200 rounded-sm" /></td>
              <td className="py-4 px-4 w-36"><div className="h-4 w-20 bg-slate-200 rounded-sm" /></td>
