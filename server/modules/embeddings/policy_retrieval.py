...
def retrieve_policy_context(
    ...
    *,
    ...
    try:
        from server.modules.documents.policy.service import get_healthy_policy_allowlist
...
def _query_policy_area(
    ...
    *,
    ...
    try:
        from server.modules.documents.policy.service import validate_policy_chunks
