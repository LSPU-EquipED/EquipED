...
def build_prompt(
    ...
    *,
    ...
    instructions = [
        ...
        (
            "Every string in evidence must be an exact verbatim excerpt substring "
            "directly quoted from the cited chunk_id in document_chunks. If confirming "
            "absence of an issue or no direct quote applies, evidence MUST be an empty "
            "list []. Do NOT write summaries, explanations, or commentary in the "
            "evidence array."
        ),
