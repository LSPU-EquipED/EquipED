...
from ``slicing.py`` -- these groups only re-package criteria that already
...
_SLICERS = {
    "assessment_alignment": slicing.slice_for_basket_a1,
    "task_execution": slicing.slice_for_basket_a2,
    "document_wide": slicing.slice_for_basket_b1,
}
